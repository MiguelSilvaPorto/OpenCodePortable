...
if (Test-Path $sttFile) {
    ...
    if (($content -match "DialogInput") -or ($content -notmatch 'kv\.get\("stt\.apiKey"\)') -or ($content -notmatch "llama-3.1-8b-instant") -or ($llmContent -and $llmContent -notmatch "groq.com")) {
